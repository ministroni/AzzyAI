...
namespace AzzyAIConfig
{
    ...
    {
        public PvpTact(string id, TACT_BASIC basic = TACT_BASIC.TACT_REACT_L, TACT_SKILL skill = AzzyAIConfig.TACT_SKILL.SKILL_ALWAYS, TACT_KITE kite = TACT_KITE.KITE_NEVER, TACT_CAST cast = TACT_CAST.CAST_REACT, TACT_PUSHBACK push = TACT_PUSHBACK.PUSH_NEVER, TACT_DEBUFF debuff = TACT_DEBUFF.DEBUFF_NEVER, TACT_SKILLCLASS size = TACT_SKILLCLASS.CLASS_S, TACT_RESCUE rescue = TACT_RESCUE.RESCUE_NEVER)
        {
        ...
        TACT_SKILL _skill = AzzyAIConfig.TACT_SKILL.SKILL_ALWAYS;
